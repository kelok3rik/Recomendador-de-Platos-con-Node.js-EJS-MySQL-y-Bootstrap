...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-04-2023 a las 20:38:27
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `mostrarPlatos` ()   BEGIN
	SELECT P.ID, P.Nombre, P.Descripcion, P.Precio, C.Nombre AS Categoria 
	FROM Plato P 
	INNER JOIN Categoria_Plato C ON P.ID_Categoria_Plato = C.ID;
END$$
...
(6, 'Pan de Sandwich', 'Pan para realizar Sadwich'),
(7, 'Pan de hamburguesa', 'Pan de hamburguesa artesanal'),
(8, 'Carne de res', 'Carne de res de primera calidad'),
(9, 'Queso cheddar', 'Queso cheddar fundido'),
(10, 'Tortilla de maíz', 'Tortilla de maí '),
(11, 'Cebolla', 'Cebolla'),
(12, 'Cilantro', 'Cilantro'),
(13, 'Limón', 'Limón'),
(14, 'Carne de pollo frita', 'Carne de pollo frita wwww');
...
(1, 'Hamburguesa con queso', 'Deliciosa hamburguesa con queso cheddar', '14.50', 8),
(2, 'Taco de Res', 'Delicioso taco de res', '10.99', 9);
...
(1, 1, 7, '2.00', 'unidades', 1),
(2, 1, 8, '150.00', 'gramos', 2),
(3, 1, 9, '2.00', 'rebanadas', 3),
(4, 2, 10, '1.00', 'Unidad', 1),
(5, 2, 11, '1.00', 'taza', 5),
(6, 2, 8, '5.00', 'gramos', 1),
(7, 2, 12, '1.00', '1/2', 4);
